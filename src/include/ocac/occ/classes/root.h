...
#define OCAC_CLASS_ROOT_01m01       {{1,1}, ocac_root_getClassIdentification}
#define OCAC_CLASS_ROOT_01m02       {{1,2}, ocac_root_getLockable}
#define OCAC_CLASS_ROOT_01m03       {{1,3}, ocac_root_lock}
#define OCAC_CLASS_ROOT_01m04       {{1,4}, ocac_root_unlock}
#define OCAC_CLASS_ROOT_01m05       {{1,5}, ocac_root_getRole}
...
OcaStatus ocac_root_getClassIdentification(OCAC_BASE_OBJ * obj, u8_t * argv, u16_t argvlen, u8_t * rsp, u16_t * rsplen, u16_t maxrsplen);
