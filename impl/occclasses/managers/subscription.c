...
OcaStatus ocac_m_devicemanager_addSubscription(OCAC_OBJ_BASE * obj, u8_t * req, u32_t reqlen, u8_t * rsp, u32_t * rsplen, u32_t maxrsplen, struct ocac_session * session)
{
...
OcaStatus ocac_m_devicemanager_removeSubscription(OCAC_OBJ_BASE * obj, u8_t * req, u32_t reqlen, u8_t * rsp, u32_t * rsplen, u32_t maxrsplen, struct ocac_session * session)
{
    OCAC_METHOD_ASSERT_PARAMS
...
OcaStatus ocac_m_devicemanager_disableNotifications(OCAC_OBJ_BASE * obj, u8_t * req, u32_t reqlen, u8_t * rsp, u32_t * rsplen, u32_t maxrsplen, struct ocac_session * session)
{
    OCAC_METHOD_ASSERT_PARAMS
...
OcaStatus ocac_m_devicemanager_reenableNotifications(OCAC_OBJ_BASE * obj, u8_t * req, u32_t reqlen, u8_t * rsp, u32_t * rsplen, u32_t maxrsplen, struct ocac_session * session)
{
    OCAC_METHOD_ASSERT_PARAMS
